...
class DQN_agent(object):
    ...
    def save(self, algo, EnvName, steps, para_rho):
        torch.save(self.q_net.state_dict(), "./model/{}_{}_{}_{}.pth".format(algo, EnvName, steps, para_rho))

    def load(self, algo, EnvName, steps, para_rho):
        self.q_net.load_state_dict(torch.load("./model/{}_{}_{}_{}.pth".format(algo, EnvName, steps, para_rho)))
        self.q_target.load_state_dict(torch.load("./model/{}_{}_{}_{}.pth".format(algo, EnvName, steps, para_rho)))
